...
![Version](https://img.shields.io/badge/version-2.5.11-4c1d95)
...
- **MAC Address Randomization** - Automatic MAC address randomization on every boot with valid vendor prefixes (runs early, before VPN startup)
