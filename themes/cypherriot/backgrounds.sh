...
cp ~/.local/share/omarchy/themes/cypherriot/backgrounds/Anime-Purple-eyes.png "$BACKGROUNDS_DIR/cypherriot/5-Anime-Purple-eyes.png"

# Copy cyber wallpaper (already in repo)
cp ~/.local/share/omarchy/themes/cypherriot/backgrounds/cyber.jpg "$BACKGROUNDS_DIR/cypherriot/6-cyber.jpg"
