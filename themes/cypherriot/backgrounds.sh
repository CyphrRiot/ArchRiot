...
cp ~/.local/share/omarchy/themes/cypherriot/backgrounds/tokyo_cat.jpeg "$BACKGROUNDS_DIR/cypherriot/2-tokyo_cat.jpeg"
...
cp ~/.local/share/omarchy/themes/cypherriot/backgrounds/blue_night_moon_over_lake.jpg "$BACKGROUNDS_DIR/cypherriot/4-blue_night_moon_over_lake.jpg"

# Copy Staircase wallpaper (already in repo)
cp ~/.local/share/omarchy/themes/cypherriot/backgrounds/Staircase.png "$BACKGROUNDS_DIR/cypherriot/5-Staircase.png"

# Copy Anime Purple Eyes wallpaper (already in repo)
cp ~/.local/share/omarchy/themes/cypherriot/backgrounds/Anime-Purple-eyes.png "$BACKGROUNDS_DIR/cypherriot/6-Anime-Purple-eyes.png"

# Copy purple sky wallpaper (already in repo)
cp ~/.local/share/omarchy/themes/cypherriot/backgrounds/purple_sky.jpeg "$BACKGROUNDS_DIR/cypherriot/7-purple_sky.jpeg"

# Copy cyber wallpaper (already in repo)
cp ~/.local/share/omarchy/themes/cypherriot/backgrounds/cyber.jpg "$BACKGROUNDS_DIR/cypherriot/8-cyber.jpg"
