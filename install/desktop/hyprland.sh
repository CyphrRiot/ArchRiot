...
setup_hyprland_packages() {
    ...
    local utilities="waybar wofi mako swaybg hyprlock hypridle grim slurp hyprshot hyprpicker hyprland-qtutils"
...
show_summary() {
    ...
    echo ""
    echo "📦 Installed: Hyprland WM, Waybar, Wofi launcher, Mako notifications, screen tools"
